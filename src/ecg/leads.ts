...
/** Alias used by the continuous recording monitor layouts. */
export const LEAD_PRINT_GRID: readonly (readonly LeadName[])[] = LEAD_GRID

/** Limb + augmented teaching set for six-lead monitor mode. */
...
/**
 * Project a cardiac dipole onto all 12 leads (Einthoven-consistent limb leads).
 * Used by the continuous recording morphology sampler (#17).
 */
